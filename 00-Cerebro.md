...
- [[03-Produtos/growth-machine/reconciliacao-vault-externa-v1-9-19]] (2026-07-10, **bloqueada aguardando acesso**) — o PO descreveu uma **vault externa** com PRD v1.9.19 (5 versões à frente do Drive mapeado) e uma pasta de propostas não aprovadas ("10-modelo-proposto-v2"). Achado crítico: **colisão real** entre nossas RN-123/RN-124 (propostas) e as deles ("paridade de canal em leads") — corrigida na hora renumerando as nossas 16 novas para `RN-SGA-01…16`. "Cluster Wrapping" da vault externa **valida de forma independente** nossa ADR de cluster (mesmo nome, mesma lógica). Pesos ainda em 40/40/20 lá — ADR de pesos mantida "aceita" mas com ressalva. Link de pasta fornecido pelo PO retornou sem acesso — aguardando liberação.
- [[04-Decisões/adr-pesos-indice-performance-2026]] (2026-07-10) — Índice de Performance revisado para **35% posicionamento / 20% tráfego / 45% leads** (RN-18), fundamentado no consenso 2026 de que tráfego é o sinal mais erodido por zero-click/AI Overview (60% das buscas sem clique) — substitui tanto o 40/40/20 original quanto o 40/30/30 do Gregory.
...
- [[04-Decisões/adr-pesos-indice-performance-2026]] — revisa RN-18 (pesos do Índice de Performance) para 35/20/45, resolvendo o conflito C1 com as regras do Gregory à luz do consenso de mercado 2026.
