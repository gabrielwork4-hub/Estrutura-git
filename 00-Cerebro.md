...
- [[03-Produtos/growth-machine/plano-fechamento-prd-v2]] (2026-07-08) — **tracker de fechamento do PRD**: consolida tudo acima em 9 decisões-gate (G1-G9, ex: pesos 40/30/30, North Star, faseamento MVP), 5 trilhas paralelas (RN, 13 blocos, SEO/GEO/AEO, integração, prompts) e o checklist dimensão a dimensão do que entra no PRD ajustado (Dim 1/2/3/5/6/7/8/11), com marca de fase MVP/Fase 2. Define "PRD fechado" como critério de saída.
