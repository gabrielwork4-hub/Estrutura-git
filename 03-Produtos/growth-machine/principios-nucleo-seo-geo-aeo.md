...
| 2 | Poda de conteúdo — RN-84 revisada (2026-07-13): scoring objetivo (tráfego GSC ≥6 meses ~0, quase-duplicata, sem backlink) → consolidar/melhorar/remover, nunca automático | **RF-55**, RN-84 | SEO | Continua alta prioridade — regra agora formalizada e alinhada à prática real de "content pruning" do Helpful Content System — cede o #1 para o item 1, que é risco ativo, não só contradição de boa prática |
